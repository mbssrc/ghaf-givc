...
=== "First Steps"
    ...
    * **Individual tests can be run in the devshell:**
      ```bash
      run-vm-test admin
      ```
...
=== "Configure Modules"
    ...
    > **IMPORTANT** <br>
    > Please refer to the [developer documentation](./api.md) for detailed documentation of the NixOS modules; and examine the configurations of the [automated tests](https://github.com/tiiuae/ghaf-givc/tree/main/nixos/tests) or the [Ghaf project](https://github.com/tiiuae/ghaf/tree/main/modules/givc) as reference.
...
=== "Development"
    ...
    To develop modules using this framework, you can write your module ideally in Go or Rust and use the provided protobuf definitions and utility. Improvements are always welcome.
