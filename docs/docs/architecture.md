...
=== "Components"
    ![GIVC Components](images/givc.svg#center)

    ## Components Structure
    The [Admin Service](#admin-service) and [Agent](#agent-module) components follow a simple structure in two layers:
    ...
    | Business Logic | The Business Logic implements the functionality of the service. After arguments are unwrapped in the Transport Layer, arguments are (filtered/validated and) forwarded to the particular service implementation. |
...
=== "Registration"
    ![GIVC Reg](images/givc-reg.svg#center)

    ## Startup and registration
    Virtual machines are started as part of the host systemd startup procedure. The [GIVC agents](#agent-module) in [application VM](#appvm-module), [service VM](#sysvm-module) and the [host](#host-module) are started when the VMs boot, and connect to the [Admin Service](#admin-service).
...
=== "Application Management"
    ![GIVC App](images/givc-app.svg#center)
...
=== "Dbus Applications"
    ![GIVC Dbus](images/givc-dbus.svg#center)
